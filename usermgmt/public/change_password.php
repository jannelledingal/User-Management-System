...
<head>
    ...
    <style>
        ...
        .form-control { 
            ...
            border: 1px solid #444746; 
            color: #ffffff !important; 
            border-right: none; /* Merges with toggle button */
        }
        .form-control:focus {
            background-color: #131314;
            color: #fff;
        ...
        /* High-Visibility Toggle Styles */
        .input-group-text {
            background-color: #a8c7fa !important; /* Gemini Blue */
            border: 1px solid #a8c7fa;
            color: #062e6f !important; /* Dark icon contrast */
            cursor: pointer;
